...
{
    /// <summary>
    /// An automaton state transition tree. This class contains a binary search
    /// tree for the automaton transitions from one state to another. All
    /// transitions are linked to a single character. 
    /// </summary>
